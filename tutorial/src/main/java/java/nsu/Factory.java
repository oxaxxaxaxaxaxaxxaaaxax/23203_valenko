...
public class Factory implements EntityFactory {
    ...
    public Entity enemy(SpawnData data){
        ...
        ViewEntityComponent view = enemy.getComponent(ViewEntityComponent.class);
        enemy.addComponent(new EnemyComponent(data.getX(), data.<Integer>get("width")+data.getX(), handler));
