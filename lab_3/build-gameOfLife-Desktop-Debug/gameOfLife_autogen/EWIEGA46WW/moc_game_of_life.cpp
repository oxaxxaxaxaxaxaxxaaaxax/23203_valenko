/****************************************************************************
** Meta object code from reading C++ file 'game_of_life.h'
**
...
#error "The header file 'game_of_life.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 6, 11), // "ChangeState"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 1), // "x"
QT_MOC_LITERAL(4, 21, 1), // "y"
QT_MOC_LITERAL(5, 23, 11) // "ChangeField"

    },
    "Field\0ChangeState\0\0x\0y\0ChangeField"
};
...
void Field::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->ChangeState((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->ChangeField(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Field::ChangeState)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Field::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Field::ChangeField)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Field::ChangeState(int _t1, int _t2)
{
